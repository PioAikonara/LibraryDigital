...
<h1 class="text-2xl font-semibold mb-6">My Borrow History</h1>
    ...
    <table class="min-w-full">
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    @if($borrow->status === 'borrowed')                        <form action="{{ route('user.borrows.return', $borrow) }}" method="POST" class="inline">
                            @csrf
