...
<div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-6 mb-6">
    ...
    <p class="text-white opacity-90">Track your book activities</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-6 transform transition-all duration-300 hover:scale-105">
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-xl font-semibold mb-2 text-blue-800">My Active Borrows</h3>
    ...
    <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg shadow-lg p-6 transform transition-all duration-300 hover:scale-105">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text text-transparent">
...
<div class="mt-8">
    <h2 class="text-2xl font-bold mb-4 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">My Recent Borrows</h2>
